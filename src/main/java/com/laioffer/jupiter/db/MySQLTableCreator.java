...
public class MySQLTableCreator {
    ...
    public static void main(String[] args) {
        try {
            ...
            Statement statement = conn.createStatement(); // statement - basic unit of sql language
            String sql = "DROP TABLE IF EXISTS favorite_records";// one statement writes one sql
            statement.executeUpdate(sql); // sends sql sentence to DB
